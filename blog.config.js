...
const BLOG = {
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, Pixel Com, Pixel Community Org, GameDev, Game Dev, game dev, Game Developmect, object oriented programming, programming, programming languages, godot, unreal engine, Blender, 3D Modelling, render, uv, animation, blender, computer science, 游戏开发, 编程语音, 面向对象, 虚幻引擎, 建模, 渲染, 动画, 电脑科学, 计算机科学', // 网站关键词 英文逗号隔开
