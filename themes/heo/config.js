const CONFIG = {
  ...
  // 英雄区显示三个置顶分类
  HERO_CATEGORY_1: { title: '会员发表', url: '/tag/会员发表' },
  HERO_CATEGORY_2: { title: '通告', url: '/tag/通告' },
  ...
  INFO_CARD_URL: 'https://github.com/PixelComOrg', // 个人资料底部按钮链接
  ...
  GROUP_ICONS: [
    {
      ...
      color_1: '#989bf8',
      title_2: 'UnrealEngine',
      img_2: '/images/heo/unreal-logo.webp',
      color_2: '#ffffff'
    },
    {
      title_1: 'Docker',
    ...
    {
      title_1: 'CPlusPlus',
      img_1: '/images/heo/cplusplus.webp',
      color_1: '#ffffff',
      title_2: 'Godot',
